...
```
$ zellij plugin -- https://github.com/ursm/zellij-foreman/releases/download/v0.1.5/zellij-foreman.wasm
```
...
```
$ zellij plugin --configuration procfile=Procfile.dev -- https://github.com/ursm/zellij-foreman/releases/download/v0.1.5/zellij-foreman.wasm
```
